...
public class EntityRegistry
{
	public static void init()
	{
		...
		EntityRegistry.addMapping(EntityHail.class, "weather_hail", 0, 128, 5, true);
		EntityRegistry.addMapping(EntityMovingBlock.class, "moving_block", 1, 128, 5, true);
		EntityRegistry.addMapping(EntityLightningEX.class, "lightning_bolt", 2, 512, 5, true);
