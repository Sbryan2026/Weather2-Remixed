...
public class Maths
{
	...
	public static class Vec
	{
		...
		public net.minecraft.util.math.vector.Vector3d toVec3MC()
		{
	    	return new net.minecraft.util.math.vector.Vector3d(posX, 0.0D, posZ);
	    }
	...
	public static class Vec3
	{
		...
		public Vec3() {}
		/**Used to create 3D vectors for positioning calculations*/
		public Vec3(net.minecraft.util.math.vector.Vector3d pos)
		{
			posX = pos.x;
			posY = pos.y;
			posZ = pos.z;
		...
		/**Calculates the square rooted distance between this 3D vector and another 3D vector*/
		public double distanceSq(net.minecraft.util.math.vector.Vector3d vector)
		{
